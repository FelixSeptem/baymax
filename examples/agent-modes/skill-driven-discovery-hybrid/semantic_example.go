...
var minimalSemanticSteps = []semanticStep{
	{Marker: "discovery_sources_prioritized", RuntimeDomain: "skill/loader", Intent: "drive discovery sources prioritized via discovery source_priority_score_mapping", Outcome: "discovery sources prioritized confirmed on skill/loader"},
	{Marker: "discovery_score_reconciled", RuntimeDomain: "context/assembler", Intent: "drive discovery score reconciled via discovery source_priority_score_mapping", Outcome: "discovery score reconciled confirmed on context/assembler"},
	{Marker: "discovery_mapping_emitted", RuntimeDomain: "skill/loader", Intent: "drive discovery mapping emitted via discovery source_priority_score_mapping", Outcome: "discovery mapping emitted confirmed on skill/loader"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_skill_gate_enforced", RuntimeDomain: "skill/loader", Intent: "drive governance skill gate enforced via discovery source_priority_score_mapping", Outcome: "governance skill gate enforced confirmed on skill/loader"},
	{Marker: "governance_skill_replay_bound", RuntimeDomain: "context/assembler", Intent: "drive governance skill replay bound via discovery source_priority_score_mapping", Outcome: "governance skill replay bound confirmed on context/assembler"},
}
