...
## Purpose
schema validation plus parser compatibility and drift-friendly payload emission.
...
- diagnostics marker: `agent_mode.structured_output_schema_contract.production_ish`
- tracing marker: `agent_mode.structured_output_schema_contract.production_ish`
