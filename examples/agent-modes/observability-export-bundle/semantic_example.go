...
var minimalSemanticSteps = []semanticStep{
	{Marker: "observability_export_collected", RuntimeDomain: "observability/event", Intent: "drive observability export collected via observability export_bundle_replay", Outcome: "observability export collected confirmed on observability/event"},
	{Marker: "observability_bundle_emitted", RuntimeDomain: "runtime/diagnostics", Intent: "drive observability bundle emitted via observability export_bundle_replay", Outcome: "observability bundle emitted confirmed on runtime/diagnostics"},
	{Marker: "observability_replay_linked", RuntimeDomain: "observability/event", Intent: "drive observability replay linked via observability export_bundle_replay", Outcome: "observability replay linked confirmed on observability/event"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_observability_gate_enforced", RuntimeDomain: "observability/event", Intent: "drive governance observability gate enforced via observability export_bundle_replay", Outcome: "governance observability gate enforced confirmed on observability/event"},
	{Marker: "governance_observability_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance observability replay bound via observability export_bundle_replay", Outcome: "governance observability replay bound confirmed on runtime/diagnostics"},
}
