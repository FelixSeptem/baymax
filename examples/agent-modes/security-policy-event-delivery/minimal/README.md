...
## Purpose
security policy decision and event emission baseline path.
...
- diagnostics marker: `agent_mode.security_policy_event_delivery.minimal`
- tracing marker: `agent_mode.security_policy_event_delivery.minimal`
