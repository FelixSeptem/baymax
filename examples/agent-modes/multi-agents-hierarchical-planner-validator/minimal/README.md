...
## Purpose
planner then validator hierarchical handoff path.
...
- diagnostics marker: `agent_mode.multi_agents_hierarchical_planner_validator.minimal`
- tracing marker: `agent_mode.multi_agents_hierarchical_planner_validator.minimal`
