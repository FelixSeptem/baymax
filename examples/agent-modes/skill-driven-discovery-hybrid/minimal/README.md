...
This variant executes source prioritization, hybrid score reconciliation, and intent-to-skill mapping without governance admission.
...
- If ranked skills are unexpected, inspect source priority and score weights in `semantic_example.go`.
