...
| `realtime-interrupt-resume` | `P2` | `realtime.durable_runtime_stream_binding` | `governance_realtime_gate_enforced; governance_realtime_replay_bound; realtime_stream_binding_expired; realtime_stream_binding_backpressure; realtime_stream_binding_disconnect_recovery` | `check-realtime-protocol-contract.*; check-agent-runtime-protocol-contract.*; check-runtime-event-stream-terminal-recovery-contract.*` | `realtime_event_protocol.v1; agent_runtime_protocol.v1/stream-binding.json; runtime_event_stream_terminal_recovery.v1` |
