...
var minimalSemanticSteps = []semanticStep{
	{Marker: "context_reference_first_selected", RuntimeDomain: "context/assembler", Intent: "drive context reference first selected via context reference_first_isolate_edit_tiering", Outcome: "context reference first selected confirmed on context/assembler"},
	{Marker: "context_isolate_handoff_applied", RuntimeDomain: "context/guard", Intent: "drive context isolate handoff applied via context reference_first_isolate_edit_tiering", Outcome: "context isolate handoff applied confirmed on context/guard"},
	{Marker: "context_edit_gate_evaluated", RuntimeDomain: "context/journal", Intent: "drive context edit gate evaluated via context reference_first_isolate_edit_tiering", Outcome: "context edit gate evaluated confirmed on context/journal"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_context_tiering_enforced", RuntimeDomain: "context/assembler", Intent: "drive governance context tiering enforced via context reference_first_isolate_edit_tiering", Outcome: "governance context tiering enforced confirmed on context/assembler"},
	{Marker: "governance_context_replay_bound", RuntimeDomain: "context/guard", Intent: "drive governance context replay bound via context reference_first_isolate_edit_tiering", Outcome: "governance context replay bound confirmed on context/guard"},
}
