...
- Reuses the same real Run/Event/Checkpoint projection path and adds a terminal-state transition rejection branch.
...
- `verification.semantic.expected_markers=protocol_run_mapped,protocol_event_mapped,protocol_checkpoint_mapped,protocol_descriptor_validated,protocol_context_validated,protocol_admission_projected,protocol_invalid_transition_rejected`
