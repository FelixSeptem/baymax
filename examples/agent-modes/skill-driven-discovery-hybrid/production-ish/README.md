...
## Purpose
hybrid discovery with AGENTS.md, folder metadata, and hybrid scoring reconciliation.
...
## Contract Mapping
- contracts: `skill-trigger-scoring`
- gates: `check-react-contract.*`
- replay: `react.v1`

## Diagnostics And Tracing Signals
- diagnostics marker: `agent_mode.skill_driven_discovery_hybrid.production_ish`
- tracing marker: `agent_mode.skill_driven_discovery_hybrid.production_ish`
