...
var minimalSemanticSteps = []semanticStep{
	{Marker: "workflow_branch_routed", RuntimeDomain: "orchestration/workflow", Intent: "drive workflow branch routed via workflow branch_retry_failfast", Outcome: "workflow branch routed confirmed on orchestration/workflow"},
	{Marker: "workflow_retry_budgeted", RuntimeDomain: "runtime/config", Intent: "drive workflow retry budgeted via workflow branch_retry_failfast", Outcome: "workflow retry budgeted confirmed on runtime/config"},
	{Marker: "workflow_failfast_classified", RuntimeDomain: "orchestration/workflow", Intent: "drive workflow failfast classified via workflow branch_retry_failfast", Outcome: "workflow failfast classified confirmed on orchestration/workflow"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_workflow_gate_enforced", RuntimeDomain: "orchestration/workflow", Intent: "drive governance workflow gate enforced via workflow branch_retry_failfast", Outcome: "governance workflow gate enforced confirmed on orchestration/workflow"},
	{Marker: "governance_workflow_replay_bound", RuntimeDomain: "runtime/config", Intent: "drive governance workflow replay bound via workflow branch_retry_failfast", Outcome: "governance workflow replay bound confirmed on runtime/config"},
}
