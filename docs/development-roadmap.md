...
截至 2026-03-18：
- 已归档并稳定：R1-R3 主线能力、A4-A12。
- 已完成（未归档）：`introduce-delayed-dispatch-not-before-contract-a13`（23/23）。
- 进行中：无。
...
已收口能力（待归档）：
- A13 定时延后执行：`not_before` 延后领取语义、delayed reason taxonomy、delayed additive diagnostics 字段。
