...
## Purpose
manifest, capability negotiation, profile replay mapping, and scaffold drift governance checks.
...
- diagnostics marker: `agent_mode.adapter_onboarding_manifest_capability.production_ish`
- tracing marker: `agent_mode.adapter_onboarding_manifest_capability.production_ish`
