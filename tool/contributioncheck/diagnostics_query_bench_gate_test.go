...
func TestDiagnosticsQueryBenchmarkBaselineEnvKeysAndValues(t *testing.T) {
	...
	required := []string{
		...
		"BAYMAX_DIAGNOSTICS_QUERY_BENCH_BASELINE_QUERY_RUNS_SANDBOX_ENRICHED_NS_OP",
		"BAYMAX_DIAGNOSTICS_QUERY_BENCH_BASELINE_QUERY_RUNS_SANDBOX_ENRICHED_P95_NS_OP",
		"BAYMAX_DIAGNOSTICS_QUERY_BENCH_BASELINE_QUERY_RUNS_SANDBOX_ENRICHED_ALLOCS_OP",
