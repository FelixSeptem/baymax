...
var runtimeDomains = []string{"mcp/stdio", "mcp/http", "mcp/profile"}

var minimalSemanticSteps = []semanticStep{
	{Marker: "transport_profile_selected", RuntimeDomain: "mcp/stdio", Intent: "drive transport profile selected via transport profile_failover_governance", Outcome: "transport profile selected confirmed on mcp/stdio"},
	{Marker: "transport_failover_decided", RuntimeDomain: "mcp/http", Intent: "drive transport failover decided via transport profile_failover_governance", Outcome: "transport failover decided confirmed on mcp/http"},
	{Marker: "transport_reason_trace_emitted", RuntimeDomain: "mcp/profile", Intent: "drive transport reason trace emitted via transport profile_failover_governance", Outcome: "transport reason trace emitted confirmed on mcp/profile"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_transport_gate_enforced", RuntimeDomain: "mcp/stdio", Intent: "drive governance transport gate enforced via transport profile_failover_governance", Outcome: "governance transport gate enforced confirmed on mcp/stdio"},
	{Marker: "governance_transport_replay_bound", RuntimeDomain: "mcp/http", Intent: "drive governance transport replay bound via transport profile_failover_governance", Outcome: "governance transport replay bound confirmed on mcp/http"},
}
