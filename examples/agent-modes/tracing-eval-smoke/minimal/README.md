...
## Purpose
trace and eval signal emission in a single-pass smoke path.
...
- diagnostics marker: `agent_mode.tracing_eval_smoke.minimal`
- tracing marker: `agent_mode.tracing_eval_smoke.minimal`
