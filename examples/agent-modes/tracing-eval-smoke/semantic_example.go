...
var minimalSemanticSteps = []semanticStep{
	{Marker: "tracing_span_emitted", RuntimeDomain: "observability/trace", Intent: "drive tracing span emitted via trace eval_feedback_loop", Outcome: "tracing span emitted confirmed on observability/trace"},
	{Marker: "eval_signal_recorded", RuntimeDomain: "runtime/diagnostics", Intent: "drive eval signal recorded via trace eval_feedback_loop", Outcome: "eval signal recorded confirmed on runtime/diagnostics"},
	{Marker: "trace_eval_loop_closed", RuntimeDomain: "observability/trace", Intent: "drive trace eval loop closed via trace eval_feedback_loop", Outcome: "trace eval loop closed confirmed on observability/trace"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_tracing_gate_enforced", RuntimeDomain: "observability/trace", Intent: "drive governance tracing gate enforced via trace eval_feedback_loop", Outcome: "governance tracing gate enforced confirmed on observability/trace"},
	{Marker: "governance_tracing_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance tracing replay bound via trace eval_feedback_loop", Outcome: "governance tracing replay bound confirmed on runtime/diagnostics"},
}
