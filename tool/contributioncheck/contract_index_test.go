...
func TestMainlineContractIndexReferencesExistingTests(t *testing.T) {
	...
	requiredRows := []string{
		...
		"Async-Await Reconcile A32 Callback-Loss Fallback",
		"Async-Await Reconcile A32 Run/Stream + Backend Parity",
		"Async-Await Reconcile A32 Replay Idempotency",
		"Async-Await Reconcile A32 Gate Path",
		"Collaboration Retry A33 Default Disabled + Transport-Only",
		"Collaboration Retry A33 Scheduler Single-Owner",
		"Collaboration Retry A33 Run/Stream + Replay Idempotency",
		"Canonical Invoke Entrypoint A34 Sync Public Surface Guard",
		"Canonical Invoke Entrypoint A34 Async Public Surface Guard",
		"Canonical Invoke Entrypoint A34 Mailbox Convergence Guard",
		"Canonical Invoke Entrypoint A34 Gate Path",
