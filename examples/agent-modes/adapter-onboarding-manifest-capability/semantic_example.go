...
var minimalSemanticSteps = []semanticStep{
	{Marker: "adapter_manifest_loaded", RuntimeDomain: "adapter/manifest", Intent: "drive adapter manifest loaded via adapter manifest_capability_fallback", Outcome: "adapter manifest loaded confirmed on adapter/manifest"},
	{Marker: "adapter_capability_negotiated", RuntimeDomain: "adapter/capability", Intent: "drive adapter capability negotiated via adapter manifest_capability_fallback", Outcome: "adapter capability negotiated confirmed on adapter/capability"},
	{Marker: "adapter_fallback_mapped", RuntimeDomain: "adapter/manifest", Intent: "drive adapter fallback mapped via adapter manifest_capability_fallback", Outcome: "adapter fallback mapped confirmed on adapter/manifest"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_adapter_gate_enforced", RuntimeDomain: "adapter/manifest", Intent: "drive governance adapter gate enforced via adapter manifest_capability_fallback", Outcome: "governance adapter gate enforced confirmed on adapter/manifest"},
	{Marker: "governance_adapter_replay_bound", RuntimeDomain: "adapter/capability", Intent: "drive governance adapter replay bound via adapter manifest_capability_fallback", Outcome: "governance adapter replay bound confirmed on adapter/capability"},
}
