...
Invoke-NativeStrict -Label "go test ./memory ./context/provider ./context/assembler ./core/runner ./runtime/diagnostics ./observability/event -run 'Test(MemoryProviderPassesGovernanceConfigToFacade|AssemblerContextStage2MemoryGovernanceDiagnosticsFields|MemoryRunDiagnosticsAccumulatorSnapshot|RunFinishedPayloadIncludesMemoryAdditiveFields|StoreRunMemoryGovernanceAdditiveFieldsPersistAndReplayIdempotent|RuntimeRecorderParsesMemoryGovernanceAdditiveFields|RuntimeRecorderMemoryGovernanceParserCompatibilityAdditiveNullableDefault)' -count=1" -Command {
