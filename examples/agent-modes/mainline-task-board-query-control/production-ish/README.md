...
## Purpose
query and control governance path with idempotent operation trace and replay classification.
...
- diagnostics marker: `agent_mode.mainline_task_board_query_control.production_ish`
- tracing marker: `agent_mode.mainline_task_board_query_control.production_ish`
