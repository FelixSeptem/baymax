...
## Purpose
diagnostics export and bundle assembly for baseline observability.
...
- diagnostics marker: `agent_mode.observability_export_bundle.minimal`
- tracing marker: `agent_mode.observability_export_bundle.minimal`
