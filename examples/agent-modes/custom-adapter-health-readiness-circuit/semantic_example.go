...
var minimalSemanticSteps = []semanticStep{
	{Marker: "adapter_health_probe_sampled", RuntimeDomain: "adapter/health", Intent: "drive adapter health probe sampled via adapterhealth readiness_backoff_circuit", Outcome: "adapter health probe sampled confirmed on adapter/health"},
	{Marker: "adapter_readiness_circuit_transitioned", RuntimeDomain: "runtime/config", Intent: "drive adapter readiness circuit transitioned via adapterhealth readiness_backoff_circuit", Outcome: "adapter readiness circuit transitioned confirmed on runtime/config"},
	{Marker: "adapter_backoff_recovery_classified", RuntimeDomain: "adapter/health", Intent: "drive adapter backoff recovery classified via adapterhealth readiness_backoff_circuit", Outcome: "adapter backoff recovery classified confirmed on adapter/health"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_adapter_health_gate_enforced", RuntimeDomain: "adapter/health", Intent: "drive governance adapter health gate enforced via adapterhealth readiness_backoff_circuit", Outcome: "governance adapter health gate enforced confirmed on adapter/health"},
	{Marker: "governance_adapter_health_replay_bound", RuntimeDomain: "runtime/config", Intent: "drive governance adapter health replay bound via adapterhealth readiness_backoff_circuit", Outcome: "governance adapter health replay bound confirmed on runtime/config"},
}
