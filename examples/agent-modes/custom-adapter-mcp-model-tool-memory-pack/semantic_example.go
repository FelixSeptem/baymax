...
var minimalSemanticSteps = []semanticStep{
	{Marker: "adapter_pack_manifest_resolved", RuntimeDomain: "adapter/scaffold", Intent: "drive adapter pack manifest resolved via adapterpack manifest_capability_memory", Outcome: "adapter pack manifest resolved confirmed on adapter/scaffold"},
	{Marker: "adapter_pack_capability_fallback", RuntimeDomain: "mcp/profile", Intent: "drive adapter pack capability fallback via adapterpack manifest_capability_memory", Outcome: "adapter pack capability fallback confirmed on mcp/profile"},
	{Marker: "adapter_pack_memory_scope_bound", RuntimeDomain: "memory", Intent: "drive adapter pack memory scope bound via adapterpack manifest_capability_memory", Outcome: "adapter pack memory scope bound confirmed on memory"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_adapter_pack_gate_enforced", RuntimeDomain: "adapter/scaffold", Intent: "drive governance adapter pack gate enforced via adapterpack manifest_capability_memory", Outcome: "governance adapter pack gate enforced confirmed on adapter/scaffold"},
	{Marker: "governance_adapter_pack_replay_bound", RuntimeDomain: "mcp/profile", Intent: "drive governance adapter pack replay bound via adapterpack manifest_capability_memory", Outcome: "governance adapter pack replay bound confirmed on mcp/profile"},
}
