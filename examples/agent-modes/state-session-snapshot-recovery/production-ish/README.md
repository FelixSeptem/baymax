...
## Purpose
snapshot export, restore, and replay idempotency checkpoints across recovery boundaries.
...
- diagnostics marker: `agent_mode.state_session_snapshot_recovery.production_ish`
- tracing marker: `agent_mode.state_session_snapshot_recovery.production_ish`
