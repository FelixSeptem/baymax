...
## Purpose
collaboration with mailbox and task-board control plus recovery replay continuity.
...
- diagnostics marker: `agent_mode.multi_agents_collab_recovery.production_ish`
- tracing marker: `agent_mode.multi_agents_collab_recovery.production_ish`
