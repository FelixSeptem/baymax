...
var minimalSemanticSteps = []semanticStep{
	{Marker: "react_plan_notebook_synced", RuntimeDomain: "core/runner", Intent: "drive react plan notebook synced via react plan_notebook_change_hooks", Outcome: "react plan notebook synced confirmed on core/runner"},
	{Marker: "react_change_hook_emitted", RuntimeDomain: "runtime/diagnostics", Intent: "drive react change hook emitted via react plan_notebook_change_hooks", Outcome: "react change hook emitted confirmed on runtime/diagnostics"},
	{Marker: "react_tool_loop_closed", RuntimeDomain: "core/runner", Intent: "drive react tool loop closed via react plan_notebook_change_hooks", Outcome: "react tool loop closed confirmed on core/runner"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_react_gate_enforced", RuntimeDomain: "core/runner", Intent: "drive governance react gate enforced via react plan_notebook_change_hooks", Outcome: "governance react gate enforced confirmed on core/runner"},
	{Marker: "governance_react_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance react replay bound via react plan_notebook_change_hooks", Outcome: "governance react replay bound confirmed on runtime/diagnostics"},
}
