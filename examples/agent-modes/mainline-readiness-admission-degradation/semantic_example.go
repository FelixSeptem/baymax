...
var minimalSemanticSteps = []semanticStep{
	{Marker: "readiness_preflight_evaluated", RuntimeDomain: "runtime/config", Intent: "drive readiness preflight evaluated via readiness admission_degradation", Outcome: "readiness preflight evaluated confirmed on runtime/config"},
	{Marker: "admission_degradation_classified", RuntimeDomain: "runtime/diagnostics", Intent: "drive admission degradation classified via readiness admission_degradation", Outcome: "admission degradation classified confirmed on runtime/diagnostics"},
	{Marker: "readiness_rollback_guarded", RuntimeDomain: "orchestration/composer", Intent: "drive readiness rollback guarded via readiness admission_degradation", Outcome: "readiness rollback guarded confirmed on orchestration/composer"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_readiness_gate_enforced", RuntimeDomain: "runtime/config", Intent: "drive governance readiness gate enforced via readiness admission_degradation", Outcome: "governance readiness gate enforced confirmed on runtime/config"},
	{Marker: "governance_readiness_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance readiness replay bound via readiness admission_degradation", Outcome: "governance readiness replay bound confirmed on runtime/diagnostics"},
}
