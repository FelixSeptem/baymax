...
var minimalSemanticSteps = []semanticStep{
	{Marker: "policy_precedence_applied", RuntimeDomain: "runtime/config", Intent: "drive policy precedence applied via policy precedence_budget_admission_trace", Outcome: "policy precedence applied confirmed on runtime/config"},
	{Marker: "budget_admission_decided", RuntimeDomain: "runtime/diagnostics", Intent: "drive budget admission decided via policy precedence_budget_admission_trace", Outcome: "budget admission decided confirmed on runtime/diagnostics"},
	{Marker: "decision_trace_recorded", RuntimeDomain: "runtime/config", Intent: "drive decision trace recorded via policy precedence_budget_admission_trace", Outcome: "decision trace recorded confirmed on runtime/config"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_policy_gate_enforced", RuntimeDomain: "runtime/config", Intent: "drive governance policy gate enforced via policy precedence_budget_admission_trace", Outcome: "governance policy gate enforced confirmed on runtime/config"},
	{Marker: "governance_policy_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance policy replay bound via policy precedence_budget_admission_trace", Outcome: "governance policy replay bound confirmed on runtime/diagnostics"},
}
