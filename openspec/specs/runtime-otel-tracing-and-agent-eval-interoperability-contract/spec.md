# runtime-otel-tracing-and-agent-eval-interoperability-contract Specification

## Purpose
TBD - created by archiving change introduce-otel-tracing-and-agent-eval-interoperability-contract-a61. Update Purpose after archive.
## Requirements
