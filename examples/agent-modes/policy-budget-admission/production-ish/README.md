...
## Purpose
precedence and budget co-governance with deterministic decision trace classification.
...
- diagnostics marker: `agent_mode.policy_budget_admission.production_ish`
- tracing marker: `agent_mode.policy_budget_admission.production_ish`
