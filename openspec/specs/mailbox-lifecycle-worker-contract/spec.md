# mailbox-lifecycle-worker-contract Specification

## Purpose
TBD - created by archiving change introduce-mailbox-lifecycle-worker-and-observability-contract-a36. Update Purpose after archive.
## Requirements
