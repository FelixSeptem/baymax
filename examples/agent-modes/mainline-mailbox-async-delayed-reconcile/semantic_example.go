...
var minimalSemanticSteps = []semanticStep{
	{Marker: "mailbox_async_delayed_dispatched", RuntimeDomain: "orchestration/mailbox", Intent: "drive mailbox async delayed dispatched via mailbox async_delayed_reconcile", Outcome: "mailbox async delayed dispatched confirmed on orchestration/mailbox"},
	{Marker: "mailbox_reconcile_triggered", RuntimeDomain: "orchestration/invoke", Intent: "drive mailbox reconcile triggered via mailbox async_delayed_reconcile", Outcome: "mailbox reconcile triggered confirmed on orchestration/invoke"},
	{Marker: "mailbox_timeline_reason_emitted", RuntimeDomain: "runtime/diagnostics", Intent: "drive mailbox timeline reason emitted via mailbox async_delayed_reconcile", Outcome: "mailbox timeline reason emitted confirmed on runtime/diagnostics"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_mailbox_gate_enforced", RuntimeDomain: "orchestration/mailbox", Intent: "drive governance mailbox gate enforced via mailbox async_delayed_reconcile", Outcome: "governance mailbox gate enforced confirmed on orchestration/mailbox"},
	{Marker: "governance_mailbox_replay_bound", RuntimeDomain: "orchestration/invoke", Intent: "drive governance mailbox replay bound via mailbox async_delayed_reconcile", Outcome: "governance mailbox replay bound confirmed on orchestration/invoke"},
}
