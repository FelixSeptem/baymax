...
var minimalSemanticSteps = []semanticStep{
	{Marker: "collab_mailbox_orchestrated", RuntimeDomain: "orchestration/collab", Intent: "drive collab mailbox orchestrated via collab mailbox_taskboard_recovery", Outcome: "collab mailbox orchestrated confirmed on orchestration/collab"},
	{Marker: "collab_task_board_reconciled", RuntimeDomain: "orchestration/mailbox", Intent: "drive collab task board reconciled via collab mailbox_taskboard_recovery", Outcome: "collab task board reconciled confirmed on orchestration/mailbox"},
	{Marker: "collab_recovery_continued", RuntimeDomain: "orchestration/scheduler", Intent: "drive collab recovery continued via collab mailbox_taskboard_recovery", Outcome: "collab recovery continued confirmed on orchestration/scheduler"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_collab_gate_enforced", RuntimeDomain: "orchestration/collab", Intent: "drive governance collab gate enforced via collab mailbox_taskboard_recovery", Outcome: "governance collab gate enforced confirmed on orchestration/collab"},
	{Marker: "governance_collab_replay_bound", RuntimeDomain: "orchestration/mailbox", Intent: "drive governance collab replay bound via collab mailbox_taskboard_recovery", Outcome: "governance collab replay bound confirmed on orchestration/mailbox"},
}
