...
func (r *RuntimeRecorder) OnEvent(ctx context.Context, ev types.Event) {
	...
	case "run.finished":
		...
		r.manager.RecordRunOwned(runtimediag.RunRecord{
			Time: ev.Time, RunID: ev.RunID,
			ProtocolSessionID: payloadString(payload, "protocol_session_id"), ProtocolState: payloadString(payload, "protocol_state"), ProtocolSource: payloadString(payload, "protocol_source"), ProtocolProfileVersion: payloadString(payload, "protocol_profile_version"), ProtocolCapabilityDecision: payloadString(payload, "protocol_capability_decision"), ProtocolCapabilityReason: payloadString(payload, "protocol_capability_reason"), ProtocolAdmissionPolicy: payloadString(payload, "protocol_admission_policy"), ProtocolAdmissionDecision: payloadString(payload, "protocol_admission_decision"), ProtocolAdmissionReason: payloadString(payload, "protocol_admission_reason"), ProtocolCheckpointID: payloadString(payload, "protocol_checkpoint_id"), ProtocolArtifactIDs: payloadStringSlice(payload, "protocol_artifact_ids"), ProtocolCheckpointRelation: payloadString(payload, "protocol_checkpoint_relation"), ProtocolCheckpointParentID: payloadString(payload, "protocol_checkpoint_parent_id"), ProtocolCheckpointBranchID: payloadString(payload, "protocol_checkpoint_branch_id"), ProtocolCheckpointRestoreSource: payloadString(payload, "protocol_checkpoint_restore_source"), ProtocolCheckpointReplayKey: payloadString(payload, "protocol_checkpoint_replay_key"), ProtocolHistoryRootID: payloadString(payload, "protocol_history_root_id"), ProtocolHistoryLeafID: payloadString(payload, "protocol_history_leaf_id"), ProtocolHistoryDigest: payloadString(payload, "protocol_history_digest"), ProtocolBranchParentLeafID: payloadString(payload, "protocol_branch_parent_leaf_id"), ProtocolRestoreOperationID: payloadString(payload, "protocol_restore_operation_id"), ProtocolReplayClassification: payloadString(payload, "protocol_replay_classification"), ProtocolWorkspaceID: payloadString(payload, "protocol_workspace_id"), ProtocolWorkspaceChangeSetID: payloadString(payload, "protocol_workspace_change_set_id"), ProtocolWorkspaceIntegrityDriftReason: payloadString(payload, "protocol_workspace_integrity_drift_reason"),
			Status:                                      status,
			TerminalState:                               payloadString(payload, "terminal_state"),
			TerminalFailureFamily:                       payloadString(payload, "terminal_failure_family"),
			TerminalPhase:                               payloadString(payload, "terminal_phase"),
			TerminalSourceReason:                        payloadString(payload, "terminal_source_reason"),
			TerminalRetryable:                           payloadBool(payload, "terminal_retryable"),
			TerminalResumable:                           payloadBool(payload, "terminal_resumable"),
			TerminalAttempt:                             payloadInt(payload, "terminal_attempt"),
			TerminalAttemptLimit:                        payloadInt(payload, "terminal_attempt_limit"),
			TerminalCausationID:                         payloadString(payload, "terminal_causation_id"),
			...
			ProviderCatalogVersion:                      payloadString(payload, "provider_catalog_version"),
			ProviderModel:                               payloadString(payload, "provider_model"),
			ProviderCapabilityOutcome:                   payloadString(payload, "provider_capability_outcome"),
			ProviderCredentialStatus:                    payloadString(payload, "provider_credential_status"),
			ProviderFallback:                            payloadString(payload, "provider_fallback"),
			ProviderAdmissionReasons:                    payloadStringSlice(payload, "provider_admission_reasons"),
			...
			EvalCorpusVersion:                           payloadString(payload, "eval_corpus_version"),
			EvalCorpusItemID:                            payloadString(payload, "eval_corpus_item_id"),
			EvalBadcaseID:                               payloadString(payload, "eval_badcase_id"),
			EvalExperimentID:                            payloadString(payload, "eval_experiment_id"),
			EvalRubricVersion:                           payloadString(payload, "eval_rubric_version"),
			EvalComparisonStatus:                        payloadString(payload, "eval_comparison_status"),
			EvalFeedbackStatus:                          payloadString(payload, "eval_feedback_status"),
			...
			StreamSubscriptionID:                        payloadString(payload, "stream_subscription_id"),
			StreamBindingPhase:                          payloadString(payload, "stream_binding_phase"),
			StreamBindingDecision:                       payloadString(payload, "stream_binding_decision"),
			StreamBindingReason:                         payloadString(payload, "stream_binding_reason"),
			StreamBindingCursorMode:                     payloadString(payload, "stream_binding_cursor_mode"),
			StreamBindingSequenceBoundary:               payloadInt64(payload, "stream_binding_sequence_boundary"),
			StreamRecoveryPhase:                         payloadString(payload, "stream_recovery_phase"),
			StreamRecoveryReason:                        payloadString(payload, "stream_recovery_reason"),
			StreamRecoveryTerminalState:                 payloadString(payload, "stream_recovery_terminal_state"),
			StreamRecoveryTerminalFailureFamily:         payloadString(payload, "stream_recovery_terminal_failure_family"),
			StreamRecoveryRetainedEventTotal:            payloadInt(payload, "stream_recovery_retained_event_total"),
			StreamRecoveryRetainedToolCallTotal:         payloadInt(payload, "stream_recovery_retained_tool_call_total"),
			StreamRecoveryTerminalConflictRecorded:      payloadBool(payload, "stream_recovery_terminal_conflict_recorded"),
