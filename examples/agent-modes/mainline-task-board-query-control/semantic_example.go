...
var minimalSemanticSteps = []semanticStep{
	{Marker: "taskboard_query_filtered", RuntimeDomain: "orchestration/scheduler", Intent: "drive taskboard query filtered via taskboard query_control_idempotency", Outcome: "taskboard query filtered confirmed on orchestration/scheduler"},
	{Marker: "taskboard_control_validated", RuntimeDomain: "runtime/diagnostics", Intent: "drive taskboard control validated via taskboard query_control_idempotency", Outcome: "taskboard control validated confirmed on runtime/diagnostics"},
	{Marker: "taskboard_operation_idempotent", RuntimeDomain: "orchestration/scheduler", Intent: "drive taskboard operation idempotent via taskboard query_control_idempotency", Outcome: "taskboard operation idempotent confirmed on orchestration/scheduler"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_taskboard_gate_enforced", RuntimeDomain: "orchestration/scheduler", Intent: "drive governance taskboard gate enforced via taskboard query_control_idempotency", Outcome: "governance taskboard gate enforced confirmed on orchestration/scheduler"},
	{Marker: "governance_taskboard_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance taskboard replay bound via taskboard query_control_idempotency", Outcome: "governance taskboard replay bound confirmed on runtime/diagnostics"},
}
