...
var minimalSemanticSteps = []semanticStep{
	{Marker: "security_policy_decision_emitted", RuntimeDomain: "runtime/security", Intent: "drive security policy decision emitted via security policy_event_delivery", Outcome: "security policy decision emitted confirmed on runtime/security"},
	{Marker: "security_event_delivery_attempted", RuntimeDomain: "observability/event", Intent: "drive security event delivery attempted via security policy_event_delivery", Outcome: "security event delivery attempted confirmed on observability/event"},
	{Marker: "security_deny_semantic_preserved", RuntimeDomain: "runtime/security", Intent: "drive security deny semantic preserved via security policy_event_delivery", Outcome: "security deny semantic preserved confirmed on runtime/security"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_security_gate_enforced", RuntimeDomain: "runtime/security", Intent: "drive governance security gate enforced via security policy_event_delivery", Outcome: "governance security gate enforced confirmed on runtime/security"},
	{Marker: "governance_security_replay_bound", RuntimeDomain: "observability/event", Intent: "drive governance security replay bound via security policy_event_delivery", Outcome: "governance security replay bound confirmed on observability/event"},
}
