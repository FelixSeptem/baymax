...
var minimalSemanticSteps = []semanticStep{
	{Marker: "hitl_checkpoint_awaited", RuntimeDomain: "orchestration/composer", Intent: "drive hitl checkpoint awaited via hitl await_resume_reject_timeout_recover", Outcome: "hitl checkpoint awaited confirmed on orchestration/composer"},
	{Marker: "hitl_resume_reject_classified", RuntimeDomain: "runtime/diagnostics", Intent: "drive hitl resume reject classified via hitl await_resume_reject_timeout_recover", Outcome: "hitl resume reject classified confirmed on runtime/diagnostics"},
	{Marker: "hitl_timeout_recoverable", RuntimeDomain: "orchestration/composer", Intent: "drive hitl timeout recoverable via hitl await_resume_reject_timeout_recover", Outcome: "hitl timeout recoverable confirmed on orchestration/composer"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_hitl_gate_enforced", RuntimeDomain: "orchestration/composer", Intent: "drive governance hitl gate enforced via hitl await_resume_reject_timeout_recover", Outcome: "governance hitl gate enforced confirmed on orchestration/composer"},
	{Marker: "governance_hitl_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance hitl replay bound via hitl await_resume_reject_timeout_recover", Outcome: "governance hitl replay bound confirmed on runtime/diagnostics"},
}
