...
## Purpose
onion-chain middleware ordering, error bubbling, and extension pass-through governance path.
...
- diagnostics marker: `agent_mode.hooks_middleware_extension_pipeline.production_ish`
- tracing marker: `agent_mode.hooks_middleware_extension_pipeline.production_ish`
