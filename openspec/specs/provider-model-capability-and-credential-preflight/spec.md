# provider-model-capability-and-credential-preflight Specification

## Purpose
TBD - created by archiving change introduce-provider-model-capability-and-credential-preflight-contract. Update Purpose after archive.
## Requirements
