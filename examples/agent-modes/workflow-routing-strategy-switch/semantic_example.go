...
var minimalSemanticSteps = []semanticStep{
	{Marker: "routing_strategy_selected", RuntimeDomain: "orchestration/workflow", Intent: "drive routing strategy selected via routing strategy_switch_confidence", Outcome: "routing strategy selected confirmed on orchestration/workflow"},
	{Marker: "routing_confidence_evaluated", RuntimeDomain: "runtime/config", Intent: "drive routing confidence evaluated via routing strategy_switch_confidence", Outcome: "routing confidence evaluated confirmed on runtime/config"},
	{Marker: "routing_switch_committed", RuntimeDomain: "orchestration/workflow", Intent: "drive routing switch committed via routing strategy_switch_confidence", Outcome: "routing switch committed confirmed on orchestration/workflow"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_routing_gate_enforced", RuntimeDomain: "orchestration/workflow", Intent: "drive governance routing gate enforced via routing strategy_switch_confidence", Outcome: "governance routing gate enforced confirmed on orchestration/workflow"},
	{Marker: "governance_routing_replay_bound", RuntimeDomain: "runtime/config", Intent: "drive governance routing replay bound via routing strategy_switch_confidence", Outcome: "governance routing replay bound confirmed on runtime/config"},
}
