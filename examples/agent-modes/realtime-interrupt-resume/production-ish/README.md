...
## Purpose
resume semantics with cursor idempotency and replay-safe interruption classification.
...
- diagnostics marker: `agent_mode.realtime_interrupt_resume.production_ish`
- tracing marker: `agent_mode.realtime_interrupt_resume.production_ish`
