...
## Purpose
large-batch mapreduce with controlled shard fanout, reduce aggregation, and retry-aware classification.
...
- diagnostics marker: `agent_mode.mapreduce_large_batch.production_ish`
- tracing marker: `agent_mode.mapreduce_large_batch.production_ish`
