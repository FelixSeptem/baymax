...
| `agent-runtime-protocol-projection` | `P1` | `agent_runtime_protocol.run_step_event_lineage` | `governance_agent_runtime_protocol_gate_enforced; governance_agent_runtime_protocol_replay_bound` | `check-agent-runtime-protocol-contract.*` | `agent_runtime_protocol.v1` |
