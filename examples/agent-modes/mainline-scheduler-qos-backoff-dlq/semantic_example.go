...
var minimalSemanticSteps = []semanticStep{
	{Marker: "scheduler_qos_fairness_applied", RuntimeDomain: "orchestration/scheduler", Intent: "drive scheduler qos fairness applied via scheduler qos_backoff_dlq", Outcome: "scheduler qos fairness applied confirmed on orchestration/scheduler"},
	{Marker: "scheduler_backoff_budgeted", RuntimeDomain: "runtime/diagnostics", Intent: "drive scheduler backoff budgeted via scheduler qos_backoff_dlq", Outcome: "scheduler backoff budgeted confirmed on runtime/diagnostics"},
	{Marker: "scheduler_dlq_classified", RuntimeDomain: "orchestration/scheduler", Intent: "drive scheduler dlq classified via scheduler qos_backoff_dlq", Outcome: "scheduler dlq classified confirmed on orchestration/scheduler"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_scheduler_gate_enforced", RuntimeDomain: "orchestration/scheduler", Intent: "drive governance scheduler gate enforced via scheduler qos_backoff_dlq", Outcome: "governance scheduler gate enforced confirmed on orchestration/scheduler"},
	{Marker: "governance_scheduler_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance scheduler replay bound via scheduler qos_backoff_dlq", Outcome: "governance scheduler replay bound confirmed on runtime/diagnostics"},
}
