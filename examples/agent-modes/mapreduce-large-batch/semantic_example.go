...
var minimalSemanticSteps = []semanticStep{
	{Marker: "mapreduce_shards_fanned_out", RuntimeDomain: "orchestration/teams", Intent: "drive mapreduce shards fanned out via mapreduce shard_reduce_retry", Outcome: "mapreduce shards fanned out confirmed on orchestration/teams"},
	{Marker: "mapreduce_reduce_aggregated", RuntimeDomain: "runtime/diagnostics", Intent: "drive mapreduce reduce aggregated via mapreduce shard_reduce_retry", Outcome: "mapreduce reduce aggregated confirmed on runtime/diagnostics"},
	{Marker: "mapreduce_retry_classified", RuntimeDomain: "orchestration/teams", Intent: "drive mapreduce retry classified via mapreduce shard_reduce_retry", Outcome: "mapreduce retry classified confirmed on orchestration/teams"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_mapreduce_gate_enforced", RuntimeDomain: "orchestration/teams", Intent: "drive governance mapreduce gate enforced via mapreduce shard_reduce_retry", Outcome: "governance mapreduce gate enforced confirmed on orchestration/teams"},
	{Marker: "governance_mapreduce_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance mapreduce replay bound via mapreduce shard_reduce_retry", Outcome: "governance mapreduce replay bound confirmed on runtime/diagnostics"},
}
