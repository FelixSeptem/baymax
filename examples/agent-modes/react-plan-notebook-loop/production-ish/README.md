...
## Purpose
react plus plan-notebook governance and hook-compatible change tracking semantics.
...
- diagnostics marker: `agent_mode.react_plan_notebook_loop.production_ish`
- tracing marker: `agent_mode.react_plan_notebook_loop.production_ish`
