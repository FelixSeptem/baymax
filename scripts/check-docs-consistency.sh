...
for marker in "MCP adapter template" "Model provider adapter template" "Tool adapter template" "onboarding skeleton"; do
...
for marker in "capability-domain" "code-snippet" "previous pattern" "recommended pattern" "compatibility notes" "additive + nullable + default + fail-fast"; do
