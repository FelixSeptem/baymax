...
## Purpose
skill discovery order over AGENTS.md then folder metadata.
...
- diagnostics marker: `agent_mode.skill_driven_discovery_hybrid.minimal`
- tracing marker: `agent_mode.skill_driven_discovery_hybrid.minimal`
