...
## Purpose
branch routing with retry policy layering and fail-fast governance signal mapping.
...
- diagnostics marker: `agent_mode.workflow_branch_retry_failfast.production_ish`
- tracing marker: `agent_mode.workflow_branch_retry_failfast.production_ish`
