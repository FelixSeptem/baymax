...
- Run diagnostics include CA3 compaction fields: `ca3_compaction_mode`, `ca3_compaction_fallback`, `ca3_compaction_retained_evidence_count`.
...
- CA3 semantic compaction quality scoring/template tuning is TODO; v1 only guarantees deterministic mode/fallback semantics and evidence-retention baseline.
