...
var minimalSemanticSteps = []semanticStep{
	{Marker: "schema_contract_loaded", RuntimeDomain: "core/types", Intent: "drive schema contract loaded via schema validate_compat_drift", Outcome: "schema contract loaded confirmed on core/types"},
	{Marker: "schema_compat_window_checked", RuntimeDomain: "runtime/diagnostics", Intent: "drive schema compat window checked via schema validate_compat_drift", Outcome: "schema compat window checked confirmed on runtime/diagnostics"},
	{Marker: "schema_drift_signal_emitted", RuntimeDomain: "core/types", Intent: "drive schema drift signal emitted via schema validate_compat_drift", Outcome: "schema drift signal emitted confirmed on core/types"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_schema_gate_enforced", RuntimeDomain: "core/types", Intent: "drive governance schema gate enforced via schema validate_compat_drift", Outcome: "governance schema gate enforced confirmed on core/types"},
	{Marker: "governance_schema_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance schema replay bound via schema validate_compat_drift", Outcome: "governance schema replay bound confirmed on runtime/diagnostics"},
}
