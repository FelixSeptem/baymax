...
## Purpose
qos fairness with retry backoff and dead-letter classification under governance constraints.
...
## Contract Mapping
- contracts: `distributed-subagent-scheduler-qos`
...
- diagnostics marker: `agent_mode.mainline_scheduler_qos_backoff_dlq.production_ish`
- tracing marker: `agent_mode.mainline_scheduler_qos_backoff_dlq.production_ish`
