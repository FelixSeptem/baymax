...
## Purpose
hot reload fail-fast with atomic rollback and deterministic diagnostics reason mapping.
...
- diagnostics marker: `agent_mode.config_hot_reload_rollback.production_ish`
- tracing marker: `agent_mode.config_hot_reload_rollback.production_ish`
