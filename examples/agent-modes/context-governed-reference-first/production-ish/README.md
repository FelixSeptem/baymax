...
- Adds `governance_context_tiering_enforced`: enforce hot/warm/cold tiers for isolated reference bundle.
- Adds `governance_context_replay_bound`: bind replay signature from selected/isolated refs, tier plan, and edit decision.
- Preserves minimal reference-first flow and appends governance enforcement.
