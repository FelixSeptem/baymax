# runtime-event-stream-terminal-recovery Specification

## Purpose
TBD - created by archiving change harden-runtime-event-stream-terminal-recovery-contract. Update Purpose after archive.
## Requirements
