# multi-provider-streaming-error-taxonomy Specification

## Purpose
TBD - created by archiving change align-multi-provider-streaming-and-error-taxonomy-m2. Update Purpose after archive.
## Requirements
