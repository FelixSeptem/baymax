...
var minimalSemanticSteps = []semanticStep{
	{Marker: "sandbox_allow_deny_classified", RuntimeDomain: "runtime/security", Intent: "drive sandbox allow deny classified via sandbox allow_deny_egress_fallback", Outcome: "sandbox allow deny classified confirmed on runtime/security"},
	{Marker: "sandbox_egress_allowlist_checked", RuntimeDomain: "tool/local", Intent: "drive sandbox egress allowlist checked via sandbox allow_deny_egress_fallback", Outcome: "sandbox egress allowlist checked confirmed on tool/local"},
	{Marker: "sandbox_fallback_path_emitted", RuntimeDomain: "runtime/security", Intent: "drive sandbox fallback path emitted via sandbox allow_deny_egress_fallback", Outcome: "sandbox fallback path emitted confirmed on runtime/security"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_sandbox_gate_enforced", RuntimeDomain: "runtime/security", Intent: "drive governance sandbox gate enforced via sandbox allow_deny_egress_fallback", Outcome: "governance sandbox gate enforced confirmed on runtime/security"},
	{Marker: "governance_sandbox_replay_bound", RuntimeDomain: "tool/local", Intent: "drive governance sandbox replay bound via sandbox allow_deny_egress_fallback", Outcome: "governance sandbox replay bound confirmed on tool/local"},
}
