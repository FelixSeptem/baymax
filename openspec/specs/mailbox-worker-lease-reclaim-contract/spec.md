# mailbox-worker-lease-reclaim-contract Specification

## Purpose
TBD - created by archiving change harden-mailbox-worker-lease-reclaim-and-panic-recovery-contract-a38. Update Purpose after archive.
## Requirements
