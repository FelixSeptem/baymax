...
func TestMultiAgentSharedContractSnapshotPass(t *testing.T) {
	...
	composerGateSpec := strings.Join([]string{
		...
		mustReadChangeSpec(t, root, "harden-long-running-recovery-boundary-and-timeout-reentry-a17", filepath.Join("specs", "go-quality-gate", "spec.md")),
		mustReadChangeSpec(t, root, "introduce-unified-run-team-workflow-task-query-api-a18", filepath.Join("specs", "go-quality-gate", "spec.md")),
	}, "\n")
	unifiedQuerySpec := mustReadChangeSpec(t, root, "introduce-unified-run-team-workflow-task-query-api-a18", filepath.Join("specs", "multi-agent-unified-query-api", "spec.md"))
	...
	snapshot := MultiAgentContractSnapshot{
		...
		MainlineContractIndexDoc:   mustRead(t, filepath.Join(root, "docs", "mainline-contract-test-index.md")),
		...
		UnifiedQuerySpec:           unifiedQuerySpec,
...
func TestValidateMultiAgentSharedContractDetectsViolations(t *testing.T) {
	snapshot := MultiAgentContractSnapshot{
		...
		MainlineContractIndexDoc:   "missing index mappings",
		...
		UnifiedQuerySpec:           "missing unified query semantics",
	...
	required := []string{
		...
		"unified_query_semantic_drift_missing_default_sort",
		"unified_query_semantic_drift_missing_opaque_cursor",
		"unified_query_semantic_drift_missing_empty_set_semantics",
		"missing_runtime_doc_unified_query_run_id_filter",
		"missing_runtime_doc_unified_query_team_id_filter",
		"missing_runtime_doc_unified_query_workflow_id_filter",
		"missing_runtime_doc_unified_query_task_id_filter",
		"missing_runtime_doc_unified_query_status_filter",
		"missing_runtime_doc_unified_query_time_range_filter",
		"missing_runtime_doc_unified_query_page_default",
		"missing_runtime_doc_unified_query_page_limit",
		"missing_runtime_doc_unified_query_sort_default",
		"missing_runtime_doc_unified_query_cursor",
		"missing_runtime_doc_unified_query_task_no_match",
		"missing_unified_query_gate_contract",
		"missing_mainline_index_unified_query_mapping",
