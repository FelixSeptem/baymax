...
var minimalSemanticSteps = []semanticStep{
	{Marker: "retrieval_candidates_built", RuntimeDomain: "memory", Intent: "drive retrieval candidates built via retrieval candidate_rerank_fallback", Outcome: "retrieval candidates built confirmed on memory"},
	{Marker: "retrieval_rerank_applied", RuntimeDomain: "context/assembler", Intent: "drive retrieval rerank applied via retrieval candidate_rerank_fallback", Outcome: "retrieval rerank applied confirmed on context/assembler"},
	{Marker: "retrieval_fallback_classified", RuntimeDomain: "memory", Intent: "drive retrieval fallback classified via retrieval candidate_rerank_fallback", Outcome: "retrieval fallback classified confirmed on memory"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_retrieval_budget_gate", RuntimeDomain: "memory", Intent: "drive governance retrieval budget gate via retrieval candidate_rerank_fallback", Outcome: "governance retrieval budget gate confirmed on memory"},
	{Marker: "governance_retrieval_replay_bound", RuntimeDomain: "context/assembler", Intent: "drive governance retrieval replay bound via retrieval candidate_rerank_fallback", Outcome: "governance retrieval replay bound confirmed on context/assembler"},
}
