...
## Purpose
hierarchical planner-validator orchestration with correction loop and governance checkpoints.
...
## Contract Mapping
- contracts: `multi-agent-collaboration-primitives`
...
- diagnostics marker: `agent_mode.multi_agents_hierarchical_planner_validator.production_ish`
- tracing marker: `agent_mode.multi_agents_hierarchical_planner_validator.production_ish`
