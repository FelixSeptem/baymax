...
Invoke-NativeStrict -Label "go test ./runtime/config ./runtime/diagnostics ./observability/event ./integration -run 'Test(ManagerGenerateDiagnosticsBundle|StoreRunObservabilityAdditiveFieldsPersistAndReplayIdempotent|StoreRunObservabilityAdditiveFieldsBoundedCardinality|RuntimeRecorderAutoGeneratesObservabilityDiagnosticsBundleSuccess|RuntimeRecorderAutoGeneratesObservabilityDiagnosticsBundleFailureReason|ObservabilityExportBundleContractRunStreamSemanticEquivalenceSuccess|ObservabilityExportBundleContractRunStreamBundleFailureTaxonomyEquivalent)' -count=1" -Command {
