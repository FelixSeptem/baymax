...
var minimalSemanticSteps = []semanticStep{
	{Marker: "middleware_onion_order_verified", RuntimeDomain: "core/runner", Intent: "drive middleware onion order verified via middleware onion_bubble_passthrough", Outcome: "middleware onion order verified confirmed on core/runner"},
	{Marker: "middleware_error_bubbled", RuntimeDomain: "tool/local", Intent: "drive middleware error bubbled via middleware onion_bubble_passthrough", Outcome: "middleware error bubbled confirmed on tool/local"},
	{Marker: "middleware_extension_passthrough", RuntimeDomain: "core/runner", Intent: "drive middleware extension passthrough via middleware onion_bubble_passthrough", Outcome: "middleware extension passthrough confirmed on core/runner"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_hooks_gate_enforced", RuntimeDomain: "core/runner", Intent: "drive governance hooks gate enforced via middleware onion_bubble_passthrough", Outcome: "governance hooks gate enforced confirmed on core/runner"},
	{Marker: "governance_hooks_replay_bound", RuntimeDomain: "tool/local", Intent: "drive governance hooks replay bound via middleware onion_bubble_passthrough", Outcome: "governance hooks replay bound confirmed on tool/local"},
}
