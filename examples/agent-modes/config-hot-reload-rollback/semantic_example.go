...
var minimalSemanticSteps = []semanticStep{
	{Marker: "config_reload_attempted", RuntimeDomain: "runtime/config", Intent: "drive config reload attempted via config reload_failfast_rollback", Outcome: "config reload attempted confirmed on runtime/config"},
	{Marker: "config_invalid_failfast", RuntimeDomain: "runtime/diagnostics", Intent: "drive config invalid failfast via config reload_failfast_rollback", Outcome: "config invalid failfast confirmed on runtime/diagnostics"},
	{Marker: "config_atomic_rollback_verified", RuntimeDomain: "runtime/config", Intent: "drive config atomic rollback verified via config reload_failfast_rollback", Outcome: "config atomic rollback verified confirmed on runtime/config"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_config_gate_enforced", RuntimeDomain: "runtime/config", Intent: "drive governance config gate enforced via config reload_failfast_rollback", Outcome: "governance config gate enforced confirmed on runtime/config"},
	{Marker: "governance_config_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance config replay bound via config reload_failfast_rollback", Outcome: "governance config replay bound confirmed on runtime/diagnostics"},
}
