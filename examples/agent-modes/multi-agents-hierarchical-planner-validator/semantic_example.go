...
var minimalSemanticSteps = []semanticStep{
	{Marker: "hierarchy_plan_decomposed", RuntimeDomain: "orchestration/teams", Intent: "drive hierarchy plan decomposed via hierarchy planner_validator_correction", Outcome: "hierarchy plan decomposed confirmed on orchestration/teams"},
	{Marker: "hierarchy_validator_feedback_applied", RuntimeDomain: "orchestration/workflow", Intent: "drive hierarchy validator feedback applied via hierarchy planner_validator_correction", Outcome: "hierarchy validator feedback applied confirmed on orchestration/workflow"},
	{Marker: "hierarchy_correction_loop_closed", RuntimeDomain: "orchestration/teams", Intent: "drive hierarchy correction loop closed via hierarchy planner_validator_correction", Outcome: "hierarchy correction loop closed confirmed on orchestration/teams"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_hierarchy_gate_enforced", RuntimeDomain: "orchestration/teams", Intent: "drive governance hierarchy gate enforced via hierarchy planner_validator_correction", Outcome: "governance hierarchy gate enforced confirmed on orchestration/teams"},
	{Marker: "governance_hierarchy_replay_bound", RuntimeDomain: "orchestration/workflow", Intent: "drive governance hierarchy replay bound via hierarchy planner_validator_correction", Outcome: "governance hierarchy replay bound confirmed on orchestration/workflow"},
}
