...
var modeSpecs = map[string]ModeSpec{
	...
	"context-governed-reference-first": {
		...
		MinimalMarkers:    []string{"context_reference_first_selected", "context_isolate_handoff_applied", "context_edit_gate_evaluated", "context_handoff_validated", "context_handoff_restore_ready"},
		...
		Gates:             []string{"check-context-jit-organization-contract.*", "check-context-compression-production-contract.*", "check-context-handoff-contract.*"},
		Replay:            []string{"context_reference_first.v1", "context_compression_production.v1", "context_handoff.v1"},
	},
	...
	"realtime-interrupt-resume": {
		...
		RuntimeDomains:    []string{"core/types", "core/runner", "observability/event", "observability/trace", "runtime/diagnostics"},
		MinimalMarkers:    []string{"realtime_cursor_idempotent", "realtime_interrupt_captured", "realtime_resume_recovered", "realtime_stream_binding_live", "realtime_stream_binding_catch_up", "realtime_stream_binding_handoff_dedup"},
		ProductionMarkers: []string{"governance_realtime_gate_enforced", "governance_realtime_replay_bound", "realtime_stream_binding_expired", "realtime_stream_binding_backpressure", "realtime_stream_binding_disconnect_recovery"},
		Contracts:         []string{"realtime-event-protocol-and-interrupt-resume-contract", "durable-runtime-event-stream-binding"},
		Gates:             []string{"check-realtime-protocol-contract.*", "check-agent-runtime-protocol-contract.*"},
		Replay:            []string{"realtime_event_protocol.v1", "agent_runtime_protocol.v1/stream-binding.json"},
	},
