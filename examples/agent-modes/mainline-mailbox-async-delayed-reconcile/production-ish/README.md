...
## Purpose
mailbox async plus delayed dispatch plus reconcile path with canonical diagnostics evidence.
...
- diagnostics marker: `agent_mode.mainline_mailbox_async_delayed_reconcile.production_ish`
- tracing marker: `agent_mode.mainline_mailbox_async_delayed_reconcile.production_ish`
