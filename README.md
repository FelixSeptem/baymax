...
当前里程碑快照（2026-09-20）：
- `preserve-provider-native-request-projection-parity`（进行中；基于归档 142 的 SDK 边界 gap fixture，修复 OpenAI、Anthropic、Gemini 的原生 role/tool-result 请求投影与 Run/Stream/CountTokens 对等；不新增 cache schema、共享 provider wire protocol 或 runtime 配置）。
