# memory-scope-and-builtin-filesystem-v2-governance-contract Specification

## Purpose
TBD - created by archiving change introduce-memory-scope-and-builtin-filesystem-v2-governance-contract-a59. Update Purpose after archive.
## Requirements
