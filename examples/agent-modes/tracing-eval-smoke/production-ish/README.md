...
## Purpose
tracing and eval interop path with replay-compatible diagnostics classification.
...
## Contract Mapping
- contracts: `otel-tracing-and-agent-eval-interoperability-contract`
- gates: `check-agent-eval-and-tracing-interop-contract.*`
- replay: `otel_semconv.v1` + `agent_eval.v1`

## Diagnostics And Tracing Signals
- diagnostics marker: `agent_mode.tracing_eval_smoke.production_ish`
- tracing marker: `agent_mode.tracing_eval_smoke.production_ish`
