...
var minimalSemanticSteps = []semanticStep{
	{Marker: "snapshot_export_emitted", RuntimeDomain: "orchestration/snapshot", Intent: "drive snapshot export emitted via snapshot export_restore_replay", Outcome: "snapshot export emitted confirmed on orchestration/snapshot"},
	{Marker: "snapshot_restore_verified", RuntimeDomain: "runtime/diagnostics", Intent: "drive snapshot restore verified via snapshot export_restore_replay", Outcome: "snapshot restore verified confirmed on runtime/diagnostics"},
	{Marker: "snapshot_replay_idempotent", RuntimeDomain: "orchestration/snapshot", Intent: "drive snapshot replay idempotent via snapshot export_restore_replay", Outcome: "snapshot replay idempotent confirmed on orchestration/snapshot"},
}

var productionGovernanceSteps = []semanticStep{
	{Marker: "governance_snapshot_gate_enforced", RuntimeDomain: "orchestration/snapshot", Intent: "drive governance snapshot gate enforced via snapshot export_restore_replay", Outcome: "governance snapshot gate enforced confirmed on orchestration/snapshot"},
	{Marker: "governance_snapshot_replay_bound", RuntimeDomain: "runtime/diagnostics", Intent: "drive governance snapshot replay bound via snapshot export_restore_replay", Outcome: "governance snapshot replay bound confirmed on runtime/diagnostics"},
}
